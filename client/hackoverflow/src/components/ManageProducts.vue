<template lang="html">
  <section>
    <save-product-form :product="productInForm" @submit="onFormSave"></save-product-form>
    <product-list :products="products" @edit="editClicked"></product-list>
  </section>
</template>
